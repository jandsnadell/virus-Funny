# OFunny
This will not lock your mouse because the mouse locking is patched.
This virus is **NOT A VIRUS**.
# Instructions
...
3. I couldn't find a good way to delete the files it creates, so you have to do it manually in C:/
